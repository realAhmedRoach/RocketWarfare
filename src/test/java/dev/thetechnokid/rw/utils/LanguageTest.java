...
public class LanguageTest {
	...
	public void testGetMultiple() {
		...
		assertEquals("Incorrect multiple en_US capitalized", "Altitude Velocity",
				Language.get("altitude velocity", true));

		Language.setLocale("es_ES");
		assertEquals("Incorrect multiple es_ES", "altitud velocidad", Language.get("altitude velocity", false));
		assertEquals("Incorrect multiple es_ES capitalized", "Altitud Velocidad",
				Language.get("altitude velocity", true));
	}
